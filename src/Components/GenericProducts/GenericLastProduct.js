...
// function generateProductCard(productDetails) {
  ...
  return (
    <>
    {console.log("SADsad", productDetailsE)}
      ...
      <div className="main-content-wrapper">
        ...
        {productDetailsE &&
          productDetailsE.map((prod, index) => {
            console.log("pdaaa" , prod)
            return (
                ...
                <div className="product-container-details">
                  ...
                  <div className="products-description">
                    <Table>
                      ...
                      <tbody>
                        {/* <tr>
                          <td>{product.descriere.regiune}</td>
                          <td>{product.descriere.altitudine}</td>
                          <td>{product.descriere.varietate}</td>
                          <td>{product.descriere.procesare}</td>
                        </tr> */}
                      </tbody>
                    </Table>
                    <ul
...
//   } else if (idType === "filtru") {
//     productDetails = productDetailsF;
//   } else if (idType === "microlot") {
